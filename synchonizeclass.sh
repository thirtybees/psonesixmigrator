...
case "${CLASS}" in
  ...
  'Tools')
    ...
    echo " - Add 'use CommerceGuys\Intl\NumberFormat\NumberFormatRepository;' in the header."
    echo " - Add 'use CommerceGuys\Intl\Formatter\NumberFormatter;' in the header."
    echo " - Add 'use PHPSQLParser\PHPSQLParser;' in the header."
    echo " - Delete Tools::redirect()."
    ...
    echo " - Delete Tools::simplexml_load_file()."
    ...
    echo " - Delete Tools::addJS()."
    echo " - Delete Tools::addCSS()."
